...
const Public = () => {
  ...
  const handledelete = async (tweetid, tweet) => {
    try {
      await axios
        .delete(`http://localhost:5000/tweet/${tweetid}`)
        .then((res) => {
          console.log(res);
  ...
  const handlereplysend = (e, tweetid) => {
    ...
    try {
      ...
      console.log(replytxt);
      axios.post("http://localhost:5000/reply", replytext).then((res) => {
        console.log(res);
        toast.info(res.data.message);
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      ...
      if (tweetimg) {
        ...
        axios.post("http://localhost:5000/tweet", form).then((res) => {
          console.log(res.data.message);
          toast.info(res.data.message);
          setreview("");
        });
